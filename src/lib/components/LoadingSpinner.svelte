...
>
    <div class="google-spinner" style="--spinner-size: {size}px; --spinner-color: {color}; --max-dash: {maxDash}; --min-dash: {minDash};">
...
<style>
    ...
    .google-spinner circle {
        ...
        animation: dash 1.6s cubic-bezier(0.4, 0.0, 0.2, 1) infinite;
    }
